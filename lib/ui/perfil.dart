...
import 'package:minha_escola/controller/dados_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Observer(
        name: 'PerfilBuilder',
        builder: (_) {
          return (dadosController.userApi != null) ? 
            ListView.builder(
              itemCount: dadosController.userApi.data.length,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget> [
                          ...
                          SizedBox(height: 30),
                          Text(
                            dadosController.userApi.data[index].nome,
                            style: TextStyle(
                              fontSize: 24
                            )  
                          ),
                          ...
                          SizedBox(height: 10),
                          Text(
                            dadosController.userApi.data[index].cdTurma.toString(),
                            style: TextStyle(
                              fontSize: 24
                            )  
                          )
